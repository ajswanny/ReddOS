...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let customFont = UIFont(name: "OpenSans-Bold", size: 20)
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.font : customFont!, NSAttributedString.Key.foregroundColor: UIColor.systemGreen]
